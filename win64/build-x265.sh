...
if [ "${MAIN_LIB_STATIC}" = 'ENABLED' ] ; then
  cmake -G "Unix Makefiles" ../../source \
    ...
    -DCMAKE_RC_COMPILER=/usr/bin/x86_64-w64-mingw32.static-windres \
    -DCMAKE_ASM_YASM_COMPILER=/usr/bin/yasm \
    -DCMAKE_CXX_FLAGS="-static-libgcc -static-libstdc++ -static -O3 -s" \
    -DCMAKE_C_FLAGS="-static-libgcc -static-libstdc++ -static -O3 -s" \
    -DCMAKE_SHARED_LIBRARY_LINK_C_FLAGS="-static-libgcc -static-libstdc++ -static -O3 -s" \
    -DCMAKE_SHARED_LIBRARY_LINK_CXX_FLAGS="-static-libgcc -static-libstdc++ -static -O3 -s" \
...
if [ "${MAIN_CLI}" = 'ENABLED' ] ; then
  ...
  cmake -G "Unix Makefiles" ../../source \
    ...
    -DCMAKE_RC_COMPILER=/usr/bin/x86_64-w64-mingw32.static-windres \
    -DCMAKE_ASM_YASM_COMPILER=/usr/bin/yasm \
    -DCMAKE_CXX_FLAGS="-static-libgcc -static-libstdc++ -lpthread -pthread -Wl,--no-as-needed -ldl -static -O3 -s" \
    -DCMAKE_C_FLAGS="-static-libgcc -static-libstdc++ -lpthread -pthread -Wl,--no-as-needed -ldl -static -O3 -s" \
    -DCMAKE_SHARED_LIBRARY_LINK_C_FLAGS="-static-libgcc -static-libstdc++ -lpthread -pthread -Wl,--no-as-needed -ldl -static -O3 -s" \
    -DCMAKE_SHARED_LIBRARY_LINK_CXX_FLAGS="-static-libgcc -static-libstdc++ -lpthread -pthread -Wl,--no-as-needed -ldl -static -O3 -s" \
